 ...
 * 1. Registering land.
 * 2. Transferring land (including an error case where a non-owner tries to transfer).
 * 3. Selling land (including an error case where a non-owner tries to sell).
 * 4. Verifying land (including an error case where an attempt is made to verify a non-registered land parcel).
 *
 * @requires hardhat
 * @requires ethers
 * @requires chai
